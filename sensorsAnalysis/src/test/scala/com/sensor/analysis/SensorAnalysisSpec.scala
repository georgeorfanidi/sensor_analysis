...
class SensorAnalysisSpec extends AsyncFreeSpec with AsyncIOSpec with Matchers {
  ...
  val bigExpected =
    s"""
       ...
       |s4, 40,44.50754331273062915332696631688120,49
       |s3, 30,34.49574721026184077763014615530625,39
       |s2, 20,24.50245281283858612431583113772934,29
       |s1, 10,14.50106302626793856827146333958094,19
       |s0, 0,4.501858736059479553903345724907063,9
       |""".stripMargin
  ...
  val veryBigExpected =
    s"""
       ...
       |s7, 70,74.49923598476731499416659313632805,79
       |s6, 60,64.50010177382377252570638831692489,69
       |s5, 50,54.50104770686610034223490796061198,59
       |s4, 40,44.49760590512067682309339980274394,49
       |s3, 30,34.49966847553349437188464508680741,39
       |s2, 20,24.49906772704135389305431654575575,29
       |s1, 10,14.50171747166256735570148804888061,19
       |s0, 0,4.497583930701369910191060994111451,9
       |""".stripMargin
